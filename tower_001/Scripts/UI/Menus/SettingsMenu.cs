...
namespace Tower_001.Scripts.UI.Menus
{
  ...
  //          backButton.Name = "BackButton";
		...
		//	backButton.SetAnchorsPreset(Control.LayoutPreset.FullRect);  // Set anchors first
		//	backButton.SizeFlagsHorizontal = Control.SizeFlags.Fill | Control.SizeFlags.Expand;  // Changed to Fill | Expand
		//	backButton.SizeFlagsVertical = Control.SizeFlags.Fill | Control.SizeFlags.Expand;    // Changed to Fill | Expand
		//	backButton.GrowHorizontal = Control.GrowDirection.Both;  // Add these grow directions
		//	backButton.GrowVertical = Control.GrowDirection.Both;    // to match TSCN
  ...
  //      }
		...
		//{
		//	_menuRoot.Show();
		//	_menuRoot.MoveToFront();

		//	// Animate both panels
		//	var leftPanelTask = Globals.Instance.MenuPanelContainer_Left.ShowWithAnimation();
		//	var rightPanelTask = Globals.Instance.MenuPanelContainer_Right.ShowWithAnimation();

		//	// Wait for both animations to complete
		//	await Task.WhenAll(leftPanelTask, rightPanelTask);
		//}

		//public override async void Hide()
		//{
		//	// Animate both panels
		//	var leftPanelTask = Globals.Instance.MenuPanelContainer_Left.HideWithAnimation();
		//	var rightPanelTask = Globals.Instance.MenuPanelContainer_Right.HideWithAnimation();
